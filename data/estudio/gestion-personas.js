...
window.ESTUDIO["gestion-personas"] = {
  ...
  tarjetas: [
    ...
    },
    {
      ...
      reverso: "a) Focos: miedo a lo desconocido / a perder el puesto (intervención: comunicar el propósito y el rol futuro, capacitar en las nuevas competencias); falta de participación y de sentido (intervención: involucrar al equipo en el rediseño y dar apoyo).\nb) Tres pasos con Lewin: 1) DESCONGELAR (crear urgencia, mostrar por qué el cambio es necesario y bajar la ansiedad); 2) CAMBIAR (implementar el nuevo modelo con participación, capacitación y apoyo, logrando triunfos tempranos); 3) RECONGELAR (anclar el cambio en la cultura, normas e incentivos para que no se revierta). (Kotter es la versión extendida de 8 pasos de esta misma lógica.)",
