...
// (Robbins, Koontz, Chiavenato; Mintzberg, Chandler, Burns & Stalker, Blake & Mouton,
//  Hersey-Blanchard, Maslow, McGregor, Herzberg, McClelland, Porter).
// Correcciones aplicadas sobre los apuntes originales:
//   - El apunte atribuía el "punto ideal 9.9" a los estudios de MICHIGAN. Es un error:
//     el 9,9 (administración en equipo) es del GRID GERENCIAL de Blake & Mouton. Los
//     estudios de Michigan solo distinguen líder orientado a las personas vs. a la
//     producción, sin coordenadas de rejilla. Se corrige en la tarjeta respectiva.
//   - Se explicitan autores clásicos que el apunte no nombraba pero sustentan el
//     contenido: "la estructura sigue a la estrategia" = Chandler; mecanicista/orgánica
//     = Burns & Stalker; los 6 elementos del diseño y las estrategias genéricas = Robbins/Porter.
...
window.ESTUDIO.administracion = {
  ...
  tarjetas: [
    ...
    },
    {
      ...
      reverso: "Planificar (definir objetivos y planes), Organizar (estructurar el trabajo), Dirigir (motivar y liderar a las personas) y Controlar (seguir, comparar y corregir). Son la columna del proceso de gestión.",
    ...
    },
    {
      ...
      reverso: "Segmentación: dividir el mercado en grupos pequeños y homogéneos. Mercado objetivo (target): el segmento donde se centran los esfuerzos. Posicionamiento: el \"lugar que ocupa la marca en la mente del consumidor\".",
    ...
    {
      id: "adm-fc-020", unidad: "U2", tema: "Cadena de Valor (Porter)",
    ...
    {
      id: "adm-fc-021", unidad: "U2", tema: "Gestión de personas (RRHH)",
    ...
    {
      id: "adm-fc-022", unidad: "U2", tema: "Reclutamiento y selección",
    ...
    {
      id: "adm-fc-023", unidad: "U2", tema: "Área de finanzas",
    ...
    {
      id: "adm-fc-024", unidad: "U2", tema: "Índices y decisiones de inversión",
    ...
    {
      id: "adm-fc-025", unidad: "U2", tema: "Nuevas tendencias",
      frente: "¿Cuáles son los tres motores de las nuevas tendencias en administración?",
      reverso: "Tecnología (internet, comercio móvil, redes, TI), Globalización (perspectiva internacional) y Espíritu emprendedor (identificar oportunidades no satisfechas). Se suman la RSE y la Gestión del Conocimiento.",
      tip: ""
    },
    {
      id: "adm-fc-026", unidad: "U2", tema: "Interrelación de las áreas",
      frente: "¿Cómo se conectan las cuatro áreas funcionales en una respuesta?",
    ...
    // ===================== U3 · PLANIFICACIÓN =====================
    {
      id: "adm-fc-027", unidad: "U3", tema: "Qué es planificar",
    ...
    {
      id: "adm-fc-028", unidad: "U3", tema: "Propósito y beneficios",
    ...
    {
      id: "adm-fc-029", unidad: "U3", tema: "Pasos de planificación (Koontz)",
    ...
    {
      id: "adm-fc-030", unidad: "U3", tema: "Tipos de objetivos",
    ...
    {
      id: "adm-fc-031", unidad: "U3", tema: "Objetivos SMART",
    ...
    {
      id: "adm-fc-032", unidad: "U3", tema: "Tradicional vs APO",
    ...
    {
      id: "adm-fc-033", unidad: "U3", tema: "Tipos de planes",
    ...
    {
      id: "adm-fc-034", unidad: "U3", tema: "Cascada de planes",
    ...
    // ===================== U4 · ORGANIZACIÓN =====================
    {
      id: "adm-fc-035", unidad: "U4", tema: "Qué es organizar",
    ...
    {
      id: "adm-fc-036", unidad: "U4", tema: "Elementos del diseño",
    ...
    {
      id: "adm-fc-037", unidad: "U4", tema: "Especialización del trabajo",
    ...
    {
      id: "adm-fc-038", unidad: "U4", tema: "Cadena de mando",
    ...
    {
      id: "adm-fc-039", unidad: "U4", tema: "Tramo de control",
    ...
    {
      id: "adm-fc-040", unidad: "U4", tema: "Mecanicista vs orgánica",
      ...
      tip: "Distinción de Burns & Stalker."
    },
    {
      id: "adm-fc-041", unidad: "U4", tema: "Diseños tradicionales",
    ...
    {
      id: "adm-fc-042", unidad: "U4", tema: "Diseños contemporáneos",
      ...
      tip: "El de red se asocia a diferenciación/enfoque y a externalizar (freelancers)."
    },
    {
      id: "adm-fc-043", unidad: "U4", tema: "Departamentalización",
    ...
    {
      id: "adm-fc-044", unidad: "U4", tema: "Departamentalización vs estructura",
    ...
    {
      id: "adm-fc-045", unidad: "U4", tema: "Centralización vs descentralización",
    ...
    // ===================== U5 · DIRECCIÓN =====================
    {
      id: "adm-fc-046", unidad: "U5", tema: "Qué es dirigir",
    ...
    {
      id: "adm-fc-047", unidad: "U5", tema: "Liderazgo",
    ...
    {
      id: "adm-fc-048", unidad: "U5", tema: "Teoría de los rasgos",
    ...
    {
      id: "adm-fc-049", unidad: "U5", tema: "Estilos de Iowa (Lewin)",
    ...
    {
      id: "adm-fc-050", unidad: "U5", tema: "Grid Gerencial (9,9)",
      ...
      tip: "Corrige el apunte: el 9,9 es de Blake & Mouton, NO de los estudios de Michigan (que solo distinguen líder orientado a personas vs. a producción)."
    },
    {
      id: "adm-fc-051", unidad: "U5", tema: "Liderazgo situacional",
    ...
    {
      id: "adm-fc-052", unidad: "U5", tema: "Transformacional vs carismático",
    ...
    {
      id: "adm-fc-053", unidad: "U5", tema: "Motivación y Maslow",
    ...
    {
      id: "adm-fc-054", unidad: "U5", tema: "Teoría X/Y y Herzberg",
    ...
    {
      id: "adm-fc-055", unidad: "U5", tema: "McClelland y contemporáneas",
    ...
    // ===================== U6 · CONTROL =====================
    {
      id: "adm-fc-056", unidad: "U6", tema: "Qué es controlar",
    ...
    {
      id: "adm-fc-057", unidad: "U6", tema: "Proceso de control",
    ...
    {
      id: "adm-fc-058", unidad: "U6", tema: "Tipos de control",
    ...
    {
      id: "adm-fc-059", unidad: "U6", tema: "Benchmarking",
    ...
    {
      id: "adm-fc-060", unidad: "U6", tema: "KPI e indicadores",
    ...
    {
      id: "adm-fc-061", unidad: "U6", tema: "Cómo se arma un KPI",
    ...
    {
      id: "adm-fc-062", unidad: "U6", tema: "Qué premian las pautas",
      frente: "¿Qué premian transversalmente las pautas del examen de Administración?",
      reverso: "Nombrar + explicar/justificar con el caso (solo nombrar = puntaje parcial). Anclar la respuesta al caso, identificar antes de justificar (poner la etiqueta correcta primero) y mantener coherencia estratégica (no mezclar diferenciación con liderazgo en costos).",
      tip: "FODA: Fortalezas/Debilidades = internas; Oportunidades/Amenazas = externas y existentes."
    }
  ]
};
